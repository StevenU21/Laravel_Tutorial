...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('products.index') }}" method="GET" class="custom-form">
            <input type="text" name="search" class="form-control custom-input" placeholder="Buscar...">
        ...
        @else
            <!-- Código existente de la tabla de productos -->
